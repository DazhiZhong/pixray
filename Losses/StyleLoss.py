...
class SymmetryLoss(LossInterface):
    ...
    def add_settings(parser):
        ...
        parser.add_argument("--style_content_weight", type=float, default=16, dest='style_content_weight')
        parser.add_argument("--style_ospace", type=str, default="uniform", dest='style_ospace') # vgg
        return parser
    ...
    def parse_settings(self,args):
        ...
        self.extractor = Vgg16_Extractor(space=args.style_ospace).to(self.device)
    ...
    def get_loss(self, cur_cutouts, out, args, globals=None, lossGlobals=None):
        ...
        return strotss_loss(out,self.resized, args.style_content_weight, extractor=self.extractor)
